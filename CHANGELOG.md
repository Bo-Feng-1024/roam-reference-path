...
### Added
 - automated regression tests (Playwright + synthetic Roam DOM fixtures) covering connector alignment on heading/normal blocks (including Roam Studio's heading margins) and no-reflow on highlight: `npm test`
